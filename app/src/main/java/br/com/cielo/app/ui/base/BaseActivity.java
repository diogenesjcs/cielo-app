package br.com.cielo.app.ui.base;
...
import br.com.cielo.app.injection.component.ActivityComponent;
import br.com.cielo.app.injection.component.ConfigPersistentComponent;
import br.com.cielo.app.injection.component.DaggerConfigPersistentComponent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (configPersistentComponent == null) {
            ...
            configPersistentComponent = DaggerConfigPersistentComponent.builder()
                    .applicationComponent(CieloApp.get(this).getComponent())
                    .build();
